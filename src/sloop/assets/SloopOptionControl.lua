...
local SloopOptionControl = Class {}
SloopOptionControl:include(MenuControl)

function SloopOptionControl:init(args)
  MenuControl.init(self)
  self:setClassName("Sloop.SloopOptionControl")
  ...
  local choicesPad = args.choicesPadding or 0
  ...
  graphic:setMargins(3, 1, (#choices + choicesPad) * ply, 1)
  graphic:fitHeight((#choices + choicesPad + descWidth) * ply - 2)
  ...
  -- instructions:vline(descWidth * ply - 2, 1, graphic.mHeight)
...
function SloopOptionControl:onReleased(i, shifted)
...
function SloopOptionControl:update()
